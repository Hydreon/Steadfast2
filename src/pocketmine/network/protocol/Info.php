...
interface Info{
	...
	const CURRENT_PROTOCOL = self::PROTOCOL_534;
	const ACCEPTED_PROTOCOLS = [419, 422, 423, 428, 431, 440, 448, 465, 471, 475, 486, 503, 526, 527, 534];
	...
	const PROTOCOL_503  = 503; // 1.18.30.32
	const PROTOCOL_526  = 526; // 1.19.0.34
