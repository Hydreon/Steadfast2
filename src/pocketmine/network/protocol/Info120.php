...
//	const RIDER_JUMP_PACKET = 0x14;
	...
	const ENTIRY_PICK_REQUEST_PACKET = 0x23;				// NEW
...
//  const UPDATE_EQUIPMENT_PACKET = 0x50;
	const RESOURCE_PACK_DATA_INFO_PACKET = 0x51;
//	const RESOURCE_PACK_CHUNK_DATA_PACKET = 0x52;
//	const RESOURCE_PACK_CHUNK_REQUEST_PACKET = 0x53;
...
//	const SHOW_STORE_OFFER_PACKET = 0x5a;
//	const PURCHASE_RECEIPT_PACKET = 0x5b;
	const PLAYER_SKIN_PACKET = 0x5c;						// NEW
	const SET_LAST_HURT_BY_PACKET = 0x5d;							// NEW
